...
7. **図解の挿入指示**: 文章だけでは分かりにくい箇所に「📊【図解】○○の仕組み」のような形式で図解の挿入ポイントを明示する
   - 例: 📊【図解】${keyword}が起こるメカニズム（原因→影響→症状の流れ）
   - 例: 📊【図解】施術の流れ（初回カウンセリング→検査→施術→アフターケア）
   - 例: 📊【図解】セルフケア3ステップ
...
7. **図解の挿入指示**: 分かりにくい箇所に「📊【図解】○○」形式で明示
   - 📊【図解】${keyword}が起こるメカニズム
   - 📊【図解】施術の流れ
   - 📊【図解】セルフケア3ステップ
8. **目次**: 記事冒頭に目次
